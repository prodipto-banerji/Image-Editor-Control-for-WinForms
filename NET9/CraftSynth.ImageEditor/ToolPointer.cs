...
{
    /// <summary>
    /// Pointer tool for .NET 9 with SkiaSharp integration
    /// </summary>
    internal class ToolPointer : Tool
    {
        ...
        private SKPoint lastPoint = new SKPoint(0, 0);
        private SKPoint startPoint = new SKPoint(0, 0);
        ...
        public override void OnMouseDown(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            SKPoint point = drawArea.BackTrackMouse(new SKPoint(e.X, e.Y));
            ...
            if (e.Button == MouseButtons.None)
            {
                ...
                if (drawArea.TheLayers[al].Graphics != null)
                {
                    ...
                    for (int i = 0; i < drawArea.TheLayers[al].Graphics.Count; i++)
                    {
                        ...
                        //if (n == 0)
                        //    toolTip.Show(drawArea.TheLayers[al].Graphics[i].TipText, drawArea, SKPointToPoint(point), 250);
                    }
                }
        ...
        public override void OnMouseUp(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            lastPoint = drawArea.BackTrackMouse(new SKPoint(e.Location.X, e.Location.Y));
        }

        #region Helper Methods

        /// <summary>
        /// Convert SKPoint to System.Drawing.Point for legacy compatibility
        /// </summary>
        /// <param name="skPoint">SKPoint to convert</param>
        /// <returns>System.Drawing.Point</returns>
        private static System.Drawing.Point SKPointToPoint(SKPoint skPoint)
        {
        ...
        private static SKPoint PointToSKPoint(System.Drawing.Point point)
        {
        ...
        protected override void Dispose(bool disposing)
        {
            if (!this._disposed)
            {
                if (disposing)
                {
                    ...
                    resizedObject?.Dispose();
                    commandChangeState?.Dispose();
                    toolTip?.Dispose();
                }
