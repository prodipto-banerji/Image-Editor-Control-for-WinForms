...
namespace CraftSynth.ImageEditor
{
    internal partial class PropertiesDialog : Form
    {
        ...
        private void SetColor()
        {
            ...
            {
                // Convert SKColor to System.Drawing.Color for WinForms compatibility
                var skColor = properties.Color.Value;
        ...
        private void ReadValues()
        {
            ...
            if (lblColor.Text.Length == 0)
            {
                ...
                var drawingColor = lblColor.BackColor;
                properties.Color = new SKColor(
                    drawingColor.R,
                    drawingColor.G,
                    drawingColor.B,
                    drawingColor.A);
