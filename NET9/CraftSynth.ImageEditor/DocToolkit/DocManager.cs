...
namespace DocToolkit
{
    ...
    /// 
    /// Migrated to .NET 9 with cross-platform compatibility in mind.
    /// No System.Drawing dependencies - compatible with SkiaSharp-based implementations.
    /// </summary>
    public class DocManager
    {
        ...
        public DocManager(DocManagerData data)
        {
            ...
            {
                // Handle registry access issues gracefully (cross-platform)
                Trace.WriteLine($"Registry access failed during initialization: {ex.Message}");
            }
        }
        ...
        /// Cross-platform note: Registry operations are Windows-specific.
        /// On Linux, this will gracefully fail and return false.
        /// </summary>
        ...
        {
            // Registry operations are Windows-specific
            if (!OperatingSystem.IsWindows())
            {
                Trace.WriteLine("File type registration is not supported on this platform.");
                return false;
            }
        ...
        /// <summary>
        /// Handle exception from RegisterFileType function
        /// </summary>
        /// <param name="ex"></param>
        /// <returns></returns>
        ...
        //    catch (Exception ex)
        //    {
        //        Trace.WriteLine($"Registry save failed: {ex.Message}");
        //    }
        //}
...
1. Write class which implements program-specific tasks. This class keeps some data,
   ...
   Example:
    ...
    public class MyTask : ISerializable
    {
        ...
        // NOTE: For .NET 9 with SkiaSharp, replace System.Drawing.Graphics with SKCanvas
        public void Draw(SKCanvas canvas, SKRect rect)
        {
            // Use SkiaSharp drawing operations instead of System.Drawing
            // ...
        }
...
4. Initialize docManager member in the form initialization code:
            ...
            // Optionally - register file type for Windows Shell (Windows only)
