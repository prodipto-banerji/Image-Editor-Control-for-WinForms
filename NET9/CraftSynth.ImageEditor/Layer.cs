...
namespace CraftSynth.ImageEditor
{
    ...
    public class Layer : IDisposable
    {
        ...
        public bool Dirty
        {
            get
            {
                if (_isDirty == false && _graphicsList != null)
        ...
        /// <summary>
        /// Draw the layer using System.Drawing.Graphics for backward compatibility
        /// </summary>
            ...
            if (!this._disposed)
            {
                if (disposing)
                {
                    ...
                    if (this._graphicsList != null)
                    {
                        ...
                        // If GraphicsList implements IDisposable, dispose it as well
                        if (this._graphicsList is IDisposable disposableList)
                        {
