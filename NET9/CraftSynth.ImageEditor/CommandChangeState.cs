...
namespace CraftSynth.ImageEditor
{
	...
	internal class CommandChangeState : Command
	{
		...
		private static void ReplaceObjects(GraphicsList graphicsList, List<DrawObject> list)
		{
		...
		private static void FillList(GraphicsList graphicsList, ref List<DrawObject>? listToFill)
		{
