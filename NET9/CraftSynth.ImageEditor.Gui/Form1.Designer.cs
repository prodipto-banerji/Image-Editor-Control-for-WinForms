namespace CraftSynth.ImageEditor.Gui
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.openFileDialog1.Filter = "Images|*.bmp;*.jpg;*.jpeg;*.png;*.gif;*.webp;*.svg";
			// 
			// saveFileDialog1
			// 
			this.saveFileDialog1.Filter = "PNG|*.png|JPEG|*.jpg|WebP|*.webp|BMP|*.bmp|GIF|*.gif";
			// 
			// imageEditor1
			// 
